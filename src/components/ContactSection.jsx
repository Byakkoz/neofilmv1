    ...
    >
      ...
      <div
        ...
        style={{
          ...
          top: isBelow768 ? '35%' : '27%', // Position descendu par rapport au cadre principal
          left: isBelow768 ? '2.5%' : '12.5%', // Centré avec marge ajustée
      ...
      <div
        ...
        style={{
          ...
          marginTop: isBelow768 ? '30%' : '10%', // Descend le cadre plus bas
